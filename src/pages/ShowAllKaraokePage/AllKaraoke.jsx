...
export default function AllKaraoke() {
  ...
  useEffect(() => {
    setLoading(true);
    getTracksByType(4) // Karaoke Instrumental TrackType = 4
      .then((data) => setTracks(data))
      .catch((err) => console.error("Error loading Karaoke Tracks:", err))
  ...
  return (
    <div className="p-4 text-white bg-hero-gradient min-h-screen">
      <div className="flex justify-between items-center">
        {/* <h2 className="text-2xl sm:text-3xl font-bold">All Karaoke Instrumentals</h2> */}
