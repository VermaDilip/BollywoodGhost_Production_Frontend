...
import { getTracksByType } from "../services/servicesApi"; // Replace with correct path
import AcapellasShimmer from "../components/shimmer/AcapellasShimmer";
import { FiChevronLeft, FiChevronRight } from "react-icons/fi";
import "./Acapellas.css";
...
export default function Acapellas() {
  ...
  useEffect(() => {
    ...
    getTracksByType(3)
      ...
      .catch((err) => console.error("Error fetching acapellas:", err))
  ...
  return (
    <>
      <div className="flex justify-between items-center px-4 mb-4">
        {/* <h2 className="text-white text-2xl font-bold">Acapella Songs</h2> */}
      ...
      {loading ? (
        <AcapellasShimmer count={visibleCount} />
      ) : (
