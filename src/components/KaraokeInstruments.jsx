...
import { getTracksByType } from "../services/servicesApi"; // Replace with your actual file path
import slugify from "slugify";
import KaraokeShimmer from "../components/shimmer/KaraokeShimmer";
import { FiChevronLeft, FiChevronRight } from "react-icons/fi";
import "./KaraokeInstruments.css";

export default function KaraokeInstruments() {
  ...
  useEffect(() => {
    ...
    getTracksByType(4)
      ...
      .catch((err) => console.error("Error fetching karaoke:", err))
  ...
  return (
    <>
      <div className="flex justify-between items-center px-4 mb-4">
        {/* <h2 className="text-white text-2xl font-bold">Karaoke Instrumental</h2> */}
      ...
      {loading ? (
        <KaraokeShimmer count={visibleCount} />
      ) : (
